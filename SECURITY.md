...
Security reports are taken seriously. If you find a vulnerability in Whack Me,
...
* Whether the issue affects players, administrators, stored data, arena
  configuration, or server configuration.
...
* Player statistics, MySQL credentials, and flat-file persistence.
* Arena setup, signs, point-block interactions, and teleport handling.
* PlaceholderAPI, NoteBlockAPI, and world-management integrations.
...
Only the latest public version of Whack Me is supported. If you are running an
older version, please update before reporting unless the same issue also exists
