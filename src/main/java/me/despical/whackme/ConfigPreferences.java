...
public class ConfigPreferences {
	...
	public enum Option {
		...
		CLEAR_INVENTORY, DATABASE_ENABLED(false),
		IGNORE_WARNING_MESSAGES(false),
		INVENTORY_MANAGER_ENABLED, JOIN_NOTIFY, LEAVE_NOTIFY, REWARDS_ENABLED(false),
		SCOREBOARD_ENABLED, UPDATE_NOTIFIER_ENABLED(false), SEND_SETUP_TIPS, DEBUG_MODE(false);
